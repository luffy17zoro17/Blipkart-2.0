             ...
             p-[5%] bg-gradient-to-t from-red-500 to-purple-600 flex lg:top-[4rem]">
              ...
              <div className="flex justify-start items-end">
                ...
                <div className="flex flex-col left-10 w-[66%]">
                  ...
                  <input
                   className="w-[16rem] px-3 py-2 my-1 rounded font-light text-sm md:w-[21rem]"
              ...
              right-[0%] font-bold text-[1vw] hidden lg:flex">
                   <div className="flex flex-col text-center justify-center items-center 
                    ...
                    <h1 className="text-green-100">Sell at 0%<br/>
                        Commission
                    </h1>
                   </div>
                   ...
                   <h2 className="text-green-100">Easy pricing <br/>calculator</h2>
                   </div>
                   ...
                   rounded-full bg-white border-2 border-blue-600 p-[14%]">
                     ...
                     <h4 className="text-green-100">500000+ <br/> sellers</h4>
                   </div>
