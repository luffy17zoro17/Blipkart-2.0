...
const LoginButton = ({setIsOpen}) => {
  return (
   ...
   flex flex-col items-center justify-center'>
    <div className='absolute z-20 bg-white h-[15rem] w-[28em] rounded-md text-black'>
    ...
    <p className='z-30 text-black text-sm w-[24rem] absolute mt-[-4.7rem]'>
    ...
    <div className='absolute z-30 flex items-center mt-[10rem] gap-[8rem] text-[0.84rem]'>
