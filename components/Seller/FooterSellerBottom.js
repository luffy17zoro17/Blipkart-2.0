...
const FooterSellerBottom = () => {
    ...
    return (
      ...
      <div className="bg-blue-500 text-white w-[100%] flex flex-col px-[3%]">
        ...
        font-light text-[0.8rem] p-[1rem] text-[2vmin]">
          <ul className="leading-[1.5rem]">
            <h1 className="font-medium leading-[2.5rem]">
              Services</h1>
          ...
          <ul className="pb-5 leading-[1.5rem] mx-[2rem]">
            <h1 className="font-medium leading-[2.5rem]">Resources</h1>
          ...
          <ul className="leading-[1.5rem]">
           <h1 className="font-medium leading-[2.5rem] mr-[9rem]">FAQs</h1>
          ...
          <ul className="leading-[1.5rem]">
           <h1 className="font-medium leading-[2.5rem] mr-[14vh]">
            Contact Us
           </h1>
          ...
          <div className="pt-2 flex flex-col px-[18rem] sm:pr-[0rem] sm:pl-[3rem] md:pt-2">
          <h1 className="text-[2.6vmin] font-medium text-white mb-2">
            Download MY App
          </h1>
          <div className="space-y-2.5">
          <div className="h-[7vmin] w-[19vmin] cursor-pointer">
            <Image
        ...
        <div className="w-[100%] flex flex-col justify-center items-center md:flex-row md:justify-evenly">  
          <div className="lg:flex lg:items-center">  
            ...
            font-light md:w-[140%] md:text-start">
            ©2022 Blipkart. All rights reserved<br/>
            </p>
          </div>  

          <div className="md:flex md:w-[60%]">
          <div className="flex justify-center w-[100%] font-light gap-[5rem] pt-2 md:flex-col 
          ...
          <div className="flex my-[2rem] gap-7 w-[100%] bottom-0 justify-center md:justify-end">
           <div className="h-[5vmin] w-[5vmin] border-4 z-10 rounded-full cursor-pointer">
             <Image 
