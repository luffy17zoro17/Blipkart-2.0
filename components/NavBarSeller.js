...
const NavBarSeller = () => {
  ...
  return (
    <div className="bg-gray-500 text-white pt-3 shadow-md
     shadow-black flex-wrap fixed w-[100%] text-[2vmin]
      flex px-[5%] z-30 top-0 justify-between
      items-start h-[6rem] lg:h-[4rem]">
     
     <div className='flex flex-wrap'>
      <div className="absolute blur-[0.02rem] left-4 top-2 z-10 w-[2.5rem] 
      h-[2.5rem] shadow cursor-pointer">   
       <Link href="/">
            <Image
     ...
     <div className='flex gap-5'>
      ...
      <span className="bg-yellow-300 text-violet-700 w-[15vmin]
       h-[4.3vmin] cursor-pointer
      ...
      <div onClick={()=>setIsOpen(true)}
       className="bg-white text-violet-700 w-[12vmin] h-[4.3vmin] z-40
